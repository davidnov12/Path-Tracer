...
int main() {
	...
	//ModelLoader ml("../model/cube.obj", ModelLoader::VERTEX_UVS_NORMALS);
	//ModelLoader ml("../model/cone.obj", ModelLoader::VERTEX_NORMALS);
	//ModelLoader ml("../model/seagul.obj", ModelLoader::VERTEX_UVS_NORMALS);
	//ModelLoader ml("../model/bunny.obj", ModelLoader::VERTEX_NORMALS);
	//ModelLoader ml("../model/bunny_v.obj", ModelLoader::VERTEX);
	...
	cornell.scaleObject(cornell.getModel(0), vec3(0.25f));
	cornell.translateObject(cornell.getModel(0), vec3(0.25f, -0.3f, -0.1f));
	cornell.rotateObject(cornell.getModel(0), -0.2, Y_AXIS);
